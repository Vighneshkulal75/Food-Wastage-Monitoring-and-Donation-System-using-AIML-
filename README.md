...
- 🥬 Detecting fruits & vegetables freshness using Machine Learning
...
🍎 1. Fruits and Vegetables Spoilage Detection
- Upload or capture images of Fruits & Vegetables
- AI predicts whether it is safe to eat
- Helps supermarkets reduce waste

🙏 2. Donation Recommendation
- Detects user location automatically (Geolocation)
